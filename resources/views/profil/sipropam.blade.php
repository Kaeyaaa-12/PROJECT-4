...
@section('content')
    ...
    <ul class="list-disc list-inside space-y-3 text-gray-700 leading-relaxed">
        <li>Memberikan pelayanan, pengendalian, dan pemantauan terhadap pengaduan masyarakat tentang penyimpangan perilaku dan tindakan pegawai Polri.</li>
        <li>Melaksanakan pembinaan dan pengamanan internal yang meliputi personel, materiil, kegiatan, dan bahan keterangan.</li>
        <li>Melakukan pembinaan dan penegakan disiplin dan/atau kode etik profesi Polri.</li>
        <li>Melaksanakan pembinaan profesi yang meliputi pembinaan etika, audit investigasi, dan penegakan etika profesi Polri.</li>
    </ul>
@endsection