...
@section('content')
    ...
    <ul class="list-disc list-inside space-y-3 text-gray-700 leading-relaxed">
        <li>Melaksanakan pelayanan dan pembinaan administrasi umum dan ketatausahaan, meliputi kesekretariatan, kearsipan, dan perpustakaan.</li>
        ...
        <li>Mengatur urusan dalam yang berkaitan dengan protokoler untuk upacara, pemakaman, dan acara dinas lainnya di lingkungan Polres.</li>
    </ul>
@endsection