...
@section('content')
    ...
    <ul class="list-disc list-inside space-y-3 text-gray-700 leading-relaxed">
        ...
        <li>Melaksanakan penegakan hukum meliputi penyidikan kecelakaan lalu lintas dan penanganan pelanggaran lalu lintas.</li>
        ...
        <li>Melakukan pembinaan manajemen operasional, pelatihan, dan pengembangan sistem teknologi informasi lalu lintas.</li>
    </ul>
@endsection