        ...
        <div class="container mx-auto px-6">
            ...
            <div class="max-w-4xl mx-auto bg-gray-50 p-8 rounded-lg shadow-lg text-gray-700">
                <p class="mb-6 leading-relaxed">
                    <strong>Astuti Mobile</strong> adalah layanan terpadu keliling yang diluncurkan oleh Polres Tulungagung untuk memudahkan masyarakat dalam mendapatkan layanan administrasi tanpa perlu datang langsung ke kantor polisi.
                </p>
                ...
                <p class="mb-6">
                    Astuti Mobile beroperasi di berbagai titik keramaian dan jadwal operasionalnya diinformasikan melalui media sosial Satlantas maupun akun resmi Polres Tulungagung.
                </p>

                <h2 class="text-2xl font-semibold text-gray-800 border-b pb-2 mb-4">Manfaat dan Tujuan</h2>
                <p>
                    Inovasi ini merupakan pengembangan dari layanan sebelumnya yang hanya mencakup SIM dan SKCK. Kini, dengan penambahan layanan imigrasi, <strong>Astuti Mobile</strong> diharapkan dapat memberikan kemudahan dan pelayanan maksimal kepada masyarakat, terutama bagi mereka yang tinggal di wilayah yang jauh dari pusat kota.
                </p>
            </div>
        </div>
    </main>
